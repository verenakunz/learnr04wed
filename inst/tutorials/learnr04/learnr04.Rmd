...
## Data
#load("df_learnr04_parlgov_election.rda") # for local testing
#load("df_learnr04_parlgov_party.rda") # for local testing
...
```{r encode, echo=FALSE}
learnrhash::encoder_ui(default_ui(url = "https://ilias.uni-mannheim.de/goto.php?target=svy_1117385&client_id=ILIAS"))
```
